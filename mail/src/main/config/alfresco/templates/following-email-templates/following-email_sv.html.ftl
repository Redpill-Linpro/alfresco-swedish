<#-- @overridden projects/repository/config/alfresco/templates/following-email-templates/following-email.html.ftl -->
<html>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div style="font-size: 22px; padding-bottom: 4px;">
                                                      ${followerLink} följer nu dig.
                                                   </div>
                                                   <div style="font-size: 13px;">
                                                      <#if followerJobTitle??>${followerJobTitle?html}<br/></#if>
                                                   </div>
                                                   <div style="font-size: 13px;">
                                                      <#if followingCount &gt; 0><span style="font-weight:bold">${followingCount}</span> följer. </#if><span style="font-weight:bold">${followerCount}</span> följare.
                                                   </div>
                                                </td>
                                             </tr>
                                          </table>
